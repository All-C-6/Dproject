...
def create_app():
    # создание экземпляра приложения, SocketIO и хранилища S3
    app = Flask(__name__)
...
if __name__ == "__main__":
    ...
    if ip:
        created_app.run(host=ip, port=5000, debug=True, threaded=True)
    else:
        created_app.run(host="192.168.3.2", port=5000, debug=True, threaded=True)
